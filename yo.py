...
def query_search_costumes(budget,age):
    query = f"send me exact links to listings(for example https://www.etsy.com/listing/....(dont show me pages or catagories, just exact links) to a {age} halloween costumes equal to or under ${budget} site:etsy.com"
    params = {
        "q": query,
        "engine": "google",
        "api_key": api_key
